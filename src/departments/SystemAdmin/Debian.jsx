...
const Debian = () => (
  <span>
    ...
    <h5>WARNING: Currently Castle has a network problem where if you are on Wifi/Ethernet network port you will be able to access internet and download packages but not be able to ssh or ping to other devices. Vice versa if you are on Lab Dev you will be able to ping and ssh but not be able to use the internet or download packages.</h5>
    ...
    <ol>
      <li>Make sure network adapter is set to Lab Dev</li>
      <li>Depending on your Opearating System ssh might differ </li>
      <li>For MacOS and Linux use terminal for Windows use PUTTY</li>
      <li>The ip addres of Castle is 10.1.1.110</li>
