...
const StepByStepSDN = () => (
  <Container className="py-3">
    ...
    <ol>
      ...
      <OpenFlowEnabled />
      <li>[Switch] the network switch will wait until the SDN controller starts, and the two will then complete a handshake.</li>
    </ol>
    <h4>The Handshake</h4>
    <ol>
